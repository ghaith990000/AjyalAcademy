...
| --- | ---------------------------------------- | -------------------------------- | ------------------------------------------------ | ---------------------------------------------------- |
| 0   | Docs & scaffold                          | **Done** (awaiting owner review) | R-13, R-16 (base), R-14 (base)                   | [PHASE-0](phases/PHASE-0-docs-and-scaffold.md)       |
| 1   | Design system & app shell                | Not started                      | R-05, R-14, R-15                                 | [PHASE-1](phases/PHASE-1-design-system-and-shell.md) |
| 2   | Supabase, auth & roles                   | Not started                      | R-01/R-02 (schema), R-10 (seed), R-11 (triggers) | [PHASE-2](phases/PHASE-2-supabase-auth-roles.md)     |
| 3   | Players                                  | Not started                      | R-01, R-06, R-07                                 | [PHASE-3](phases/PHASE-3-players.md)                 |
